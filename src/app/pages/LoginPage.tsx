...
import { Eye, EyeOff, Zap, Mail, Lock, ArrowRight, ShieldCheck } from "lucide-react";

export function LoginPage() {
  const navigate = useNavigate();
  const [email, setEmail] = useState("manager@retailai.tw");
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="mb-2">
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a
                  href="#"
                  style={{ color: "#4F46E5", fontSize: "0.78rem", fontWeight: 500, textDecoration: "none" }}
                >
                  忘記密碼？
                </a>
              </div>
